        ...
        <div className="grid md:grid-cols-[1fr_320px] gap-16 items-start">
          ...
          <div>
            <div className="space-y-5 font-sans text-base text-muted-foreground leading-relaxed mb-12">
              <p>
                I've spent 25 years at the intersection of data and business strategy &mdash; leading
              ...
              <p>
                ...
                explain why a forecasting model improved accuracy 5% &mdash; and what that means for
              ...
              <p>
                ...
                ship practical tools &mdash; things that solve real business problems, not demos.
              </p>
            </div>
            ...
            <ul className="space-y-0">
              {HIGHLIGHTS.map((h, i) => (
                <li key={i} className="flex gap-4 py-4 border-b border-border font-sans text-sm text-muted-foreground leading-relaxed">
                  <span className="text-primary mt-0.5 flex-shrink-0">&rarr;</span>
                  {h}
                </li>
              ))}
            </ul>
            ...
            {[
              {
                ...
                content: (
                  <p className="font-sans text-sm text-muted-foreground leading-relaxed">
                    Chief Analytics Officer, Overproof &mdash; building analytics & AI for beverage intelligence
                  </p>
                ),
              },
              {
              ...
              {
                label: "Location",
                content: <p className="font-sans text-sm text-muted-foreground">Minneapolis&ndash;St. Paul Metro</p>,
              },
            ].map((card) => (
